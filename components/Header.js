    ...
    return (
        <header className="sticky z-50 top-0 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
            ...
            <div className="flex items-center justify-end space-x-4 text-gray-500">
                <p className="hidden md:inline cursor-pointer">Become a host</p><GlobeAltIcon className="h-6 cursor-pointer" />
            ...
            {searchInput && (
                <div className="flex flex-col col-span-3 mx-auto">
                    ...
                    <div className="flex items-center border-b mb-4">
                        ...
                        <input value={noOfGuests} onChange={e => setNoOfGuests(e.target.value)} type="number" min={1} className="w-12 pl-2 text-lg outline-none text-blue-400" />
                    </div>
                    <div className="flex">
